\appendix{Primary literature reviewed, read in full and data extracted\label{appendix:a}}

\begin{longtable}[h]{m{2cm} | m{7cm} | c | c | c | c | c}
  \caption{Final list of literature with the inclusion/exclusion criteria applied. The list indicates each place where the license was found in.} \label{table:appendix:a} \\
  \hline
