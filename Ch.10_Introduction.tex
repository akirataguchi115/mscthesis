...
The secondary goal of this research is to conduct a systematic multivocal literature review of the current state of the PCLs in software engineering, the evaluation of the them and the evidence level of the research. The research aims to provide a novel perspective on relevant licenses and to extract key findings through a rigorous literature review process. The research questions of the review are:
\begin{itemize}
	\item RQ1: How often do PCLs in software engineering change?
	\item RQ2: How have the PCLs in software engineering changed?
	\item RQ3: How long is the average PCL in software engineering?
	\item RQ4: What are the common reasons for version changes to PCLs in software engineering?
\end{itemize}
...
As significant point of clarification, it is essential to acknowledge that the PCLs are generally meant to be used as valid legal instruments. The question whether or not a PCL can act as a legal instrument is critical to the main function of these licenses. However, this thesis will not focus on the legal doctrine aspects either. The enforceability of the PCLs has seen discussion in the academic field of law since the dawn of the PCLs and since there's already an academic base for research it is likely the discussion seems to continue on with a healthy amount of activity \citep{duisburg2011gpl}.
