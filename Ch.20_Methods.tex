...
definitely not including fsf:license:other. for example babl seems to be in that category but is actually licensed under gplv3. there are a whopping 5282 programs whose license fsf just hasn't put up yet.
